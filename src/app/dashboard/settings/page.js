...
export default function SettingsPage() {
  ...
  return (
    <div className="text-black">
      <h1 className="text-3xl text-headings font-bold mt-4">Settings</h1>
      <div className="my-6">
        ...
        <FontAwesomeIcon
            ...
            className={`text-3xl cursor-pointer ${reportEmails ? "text-secondary" : "text-gray-500"}`}
          />
            </div>
        {!isAuthenticated ? (
          <form onSubmit={handleAuthentication} className="space-y-4">
            ...
            <div className="flex justify-end">
              <button type="submit" className="bg-secondary text-white py-2 px-6 text-xl rounded-md mt-4" disabled={loading}>
